...
public class Teste {
	...
	public static void main(String[] args) {
		...
		try {
            ...
            Object o = Naming.lookup("estoque"); // ligação com o servidor remoto
            IEstoque estoqueRemoto = (IEstoque) o; // conversão de tipo
            System.out.println("não deu pau");
           
            idVenda = estoqueRemoto.registrarVenda(novaVenda);
