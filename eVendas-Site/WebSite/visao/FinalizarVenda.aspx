    ...
    <div id="divItensCompra">
        <div id="divFormItensCompra" runat="server">
            ...
            <div id="divPagamento" class="divCaixa">
                ...
                <asp:RadioButton ID="rbBoleto" runat="server" GroupName="formaPagamento" Text="" /><asp:Image ID="imgBoleto" runat="server" ImageUrl="~/images/boleto_bancario.png" AlternateText="Boleto Bancário" ImageAlign="middle"/>
                <asp:RadioButton ID="rbCartao" runat="server" GroupName="formaPagamento" Text="" /><asp:Image ID="imgCartao" runat="server" ImageUrl="~/images/cartao_evendas.png" AlternateText="Cartão eVendas" ImageAlign="middle"/>
            </div>
            &nbsp; &nbsp;
            <div id="divFecharPedido">
                <asp:ImageButton ID="imgFecharPedido" runat="server" ImageUrl="~/images/fechar_pedido.png" OnClick="imgFecharPedido_Click"/>
            </div>         
        </div>        
    </div>
</form>
