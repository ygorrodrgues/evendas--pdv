...
@id_venda int OUTPUT
AS
INSERT INTO VENDA (ID_FUNC, ID_PDV, ID_CLIENTE, DATA_VENDA) VALUES (@ID_FUNC, @ID_PDV, @ID_CLIENTE, GETDATE())
SELECT @id_venda = MAX(ID_VENDA) FROM VENDA 
GO
...
AS
	INSERT INTO Pagamento(ID_TIPO_PAGAMENTO, ID_VENDA, VALOR_PAGAMENTO) VALUES(@id_tipo_pagamento, @id_venda, @valor_pagamento)
	SELECT @id_pagamento = MAX(ID_PAGAMENTO) FROM PAGAMENTO
GO
...
@id_pagamento bigint,
@id_cartao bigint,
@valor_vencimento decimal(10,2),
@numero_parcela int
AS
INSERT INTO parcelas(ID_PAGAMENTO, ID_CARTAO, DATA_VENC, VALOR_VENC) 
	VALUES(@id_pagamento, @id_cartao, DATEADD(MONTH, @numero_parcela, GETDATE()), @valor_vencimento)
GO
/*======================================================================================================================*/
/*======================================================================================================================*/
/*======================================================================================================================*/
...
/*==============================================================*/  
/* View: SelectProdutoEmEstoque									*/  
/*==============================================================*/  
CREATE VIEW SelectProdutoEmEstoque    
AS    
SELECT DISTINCT P.ID_PRODUTO, P.CODIGO_PRODUTO, P.ID_SUBCATEGORIA, P.ID_MEDIDA, P.DESCRICAO_PRODUTO, P.NOME_PRODUTO,
P.IMAGEM_CAMINHO, I.PRECO_ITEM_PRODUTO AS CUSTO
FROM PRODUTO P  
INNER JOIN ITEM_PRODUTO I ON I.ID_PRODUTO = P.ID_PRODUTO  
WHERE I.QTD_ITEM_PRODUTO > 0
GO
...
GO
/*==============================================================*/
/* View: SelectClientePorUsuario								*/
/*==============================================================*/
CREATE VIEW SelectClientePorUsuario
AS
SELECT C.*
FROM USUARIO U
INNER JOIN CLIENTE C ON C.ID_USUARIO = U.ID_USUARIO
...
/*==============================================================*/
/* View: SelectCartaoPorCliente									*/
/*==============================================================*/
CREATE VIEW SelectCartaoPorCliente
AS
SELECT CT.*
FROM CARTAO CT
